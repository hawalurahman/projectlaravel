...
<body>
    ...
    <div class="inner">
        ...
        <div class="form">
            ...
            <div class='subtitle'>Don't have an account? <a href="SignUp.html" style="text-decoration:none;color: blue;">Sign Up</a> </div>
            <div class="google">
            ...
            <div class="formulir">
                <form name="myform" onsubmit="return validation()">
                    ...
                    <div class="SignUp">
                        <button type="submit" style="background-color:#ACEF1D;outline: none; font-weight: bold;"><a href="timeline.html" style="color: black;">Log in</a></button>
                    </div>
                </form>
            ...
            <div class="check">
                ...
                <br><a href="logincontributor.html" style="font-size: 12px;">Login as contributor</a><br>
            </div>
